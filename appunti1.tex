...
\begin{proof}
  ...
  Scegliamo quindi $n$ componenti connesse in $A$ (esistono perché
  $A\in I$, per il lemma precedente le loro distanze di Hausdorff sono
  non nulle, sia $\delta$ il minimo di queste distanze e scegliamo
  $\varepsilon = \sfrac{\delta}{3}$.

  No, è ancora sbagliata perché potrei avere una componente connessa
  che fa da ``ponte''.
\end{proof}
