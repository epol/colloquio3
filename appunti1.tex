...
Vorremo considerare le forme di $\mathbb{R}^N$ a meno di particolari
trasformazioni come rotazioni e translazioni.

Dato $G \subseteq \gl(\mathbb{R}^N)$ voglio definire $M(A)$ al
...
sono particolarmente interssato è il gruppo delle rotazioni, ma già
...
L'imitiamoci, allora a considerare i compatti $A \in K(\mathbb{R}^N)$.
